...
//				}
		...
		JMenuItem SaveRasterMenuItem = new JMenuItem("Save ...");
		SaveRasterMenuItem.setAction(save);
		fileMenu.add(SaveRasterMenuItem);
	...
	//Action - Run when opening a raster from file -> open raster 
		...
		private class SaveRaster extends AbstractAction {
			//private String fileName; 
			
			public SaveRaster() {
				putValue(NAME, "Save raster ...");
				putValue(SHORT_DESCRIPTION, "Save ASCII raster file");
			}
			public void actionPerformed(ActionEvent e) {
